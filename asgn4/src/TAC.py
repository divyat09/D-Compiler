...
def OutputTAC():
  ...
  for Instr in InstrTAC:
    ...
    if Instr[0] == 'if':
      ...
      print( LineNum + Comma +'ret' +Comma + Instr[1])

    elif Instr[0] == 'writeln':
      print( LineNum + Comma +'print_int' +Comma + Instr[1])

    elif Instr[0] == '=':
      print( LineNum + Comma + Instr[0] + Comma + Instr[1] + Comma + Instr[2] + Comma)

    elif Instr[0] == '~':
     print( LineNum + Comma + Instr[0] + Comma + Instr[1] + Comma + Instr[2] + Comma)

    elif Instr[0] in [ '+', '-', '*', '/', '%', '<<', '>>', '&', '|', '^' ] :
      print( LineNum + Comma + Instr[0] + Comma + Instr[1] + Comma + Instr[2] + Comma + Instr[3] + Comma)
