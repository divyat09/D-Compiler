...
def p_Type(p):
    ''' Type : TypeCtors_opt BasicType BasicType2_opt
    '''
    revoutput.append(p.slice)
...
def p_TypeCtors_opt(p):
    '''TypeCtors_opt : TypeCtors
		     | empty
    '''
    revoutput.append(p.slice)
...
def p_UnaryExpression(p):
    '''UnaryExpression : UAMPERSAND UnaryExpression
...
def p_CastExpression(p):
    '''CastExpression : CAST LPAREN Type RPAREN UnaryExpression
    		      | CAST LPAREN TypeCtors_opt RPAREN UnaryExpression
    '''
    revoutput.append(p.slice)     
...
def p_PostfixExpression(p):
    '''PostfixExpression : PrimaryExpression
                         ...
                         | TypeCtors_opt BasicType LPAREN ArgumentList_opt RPAREN             
    '''
...
def p_PrimaryExpression(p):
    ''' PrimaryExpression : IDENTIFIER
                          ...
                          | TypeCtor LPAREN Type RPAREN DOT IDENTIFIER
   						  | TypeCtor LPAREN Type RPAREN LPAREN ArgumentList_opt RPAREN 
    					  | Typeof
...
def p_DeclarationStatement(p):
    '''
        DeclarationStatement : StorageClasses_opt Declaration
    '''
    revoutput.append(p.slice)
...
def p_IfCondition(p):
    '''
        IfCondition : Expression
                    ...
                    | TypeCtors IDENTIFIER ASSIGN Expression
                    | TypeCtors_opt BasicType Declarator ASSIGN Expression
    '''
    revoutput.append(p.slice)
