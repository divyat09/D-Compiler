...
def ConditionalExpression(IRObj):
	...
	if IRObj.isValid()[0]:
		...
		# f = open(AssemFile,'a')
		# f.write( "// B 1 Cond Exp "+"\n")
		# f.close()

		reg1= AssignRegister( _src1, IRObj.lineno, 1 )

		# f = open(AssemFile,'a')
		# f.write( "// E 1 Cond Exp "+"\n")
		# f.close()
	...
	if IRObj.isValid()[1]:
		...
		# f = open(AssemFile,'a')
		# f.write( "// B 2 Cond Exp "+"\n")
		# f.close()

		reg2= AssignRegister( _src2, IRObj.lineno, 1 )

		# f = open(AssemFile,'a')
		# f.write( "// E 2 Cond Exp "+"\n")
		# f.close()
	...
	# f = open(AssemFile,'a')
	# f.write( "// B 3 Cond Exp "+"\n")
	# f.close()

	reg3 = AssignRegister( _dst, IRObj.lineno, 0)

	# f = open(AssemFile,'a')
	# f.write( "// E 3 Cond Exp "+"\n")
	# f.close()
...
def Conditional ( IRObj):
	...
	if IRObj.isValid()[0]:
		...
		# f = open(AssemFile,'a')
		# f.write( "// B 1 Conditional "+"\n")
		# f.close()

		reg1= AssignRegister( _src1, IRObj.lineno, 1 )

		# f = open(AssemFile,'a')
		# f.write( "// E 1 Conditional "+"\n")
		# f.close()
	else:
		_src1= IRObj.const
		flag_= 1
	...
	if IRObj.isValid()[1]:
		...
		# f = open(AssemFile,'a')
		# f.write( "// B 2 Conditional "+"\n")
		# f.close()

		reg2= AssignRegister( _src2, IRObj.lineno, 1 )

		# f = open(AssemFile,'a')
		# f.write( "// E 2 Conditional "+"\n")
		# f.close()
...
def Operator1( IRObj ):			# Add, Mul, Sub, xor, or ,and
	if IRObj.isValid()[2]:
		if IRObj.isValid()[0]:
			_src1= IRObj.src1
			# f = open(AssemFile,'a')
			# f.write( "// B 1 Operator 1 Assign"+"\n")
			# f.close()
			reg1= AssignRegister( _src1, IRObj.lineno, 1 )
			# f = open(AssemFile,'a')
			# f.write( "// E 1 Operator 1 Assign"+"\n")
			# f.close()
		...
		if IRObj.isValid()[1]:
			_src2= IRObj.src2
			# f = open(AssemFile,'a')
			# f.write( "// B 2 Operator 1 Assign"+"\n")
			# f.close()
			reg2= AssignRegister( _src2, IRObj.lineno, 1 )
			# f = open(AssemFile,'a')
			# f.write( "// E 2 Operator 1 Assign"+"\n")
			# f.close()
		...
		# f = open(AssemFile,'a')
		# f.write( "// B 3 Operator 1 Assign"+"\n")
		# f.close()

		reg3 = AssignRegister( _dst, IRObj.lineno, 0)

		# f = open(AssemFile,'a')
		# f.write( "// E 3 Operator 1 Assign"+"\n")
		# f.close()
...
def Operator2( IRObj ):			# Div, Mod
	...
	if IRObj.isValid()[2]:
		...
		if IRObj.isValid()[0]:
			...
			# f = open(AssemFile,'a')
			# f.write( "// B 1 Operator 2 Assign"+"\n")
			# f.close()

			reg1= AssignRegister( _src1, IRObj.lineno, 1 )

			# f = open(AssemFile,'a')
			# f.write( "// E 1 Operator 2 Assign"+"\n")
			# f.close()
		...
		if IRObj.isValid()[1]:
			...
			# f = open(AssemFile,'a')
			# f.write( "// B 2 Operator 2 Assign"+"\n")
			# f.close()

			reg2= AssignRegister( _src2, IRObj.lineno, 1 )

			# f = open(AssemFile,'a')
			# f.write( "// E 2 Operator 2 Assign"+"\n")
			# f.close()
...
def Operator3( IRObj ):			# left and right shift
	...
	if IRObj.isValid()[2]:
		...
		# f = open(AssemFile,'a')
		# f.write( "// B 1 Operator 3 Assign"+"\n")
		# f.close()
		
		reg3 = AssignRegister( _dst, IRObj.lineno, 0)

		# f = open(AssemFile,'a')
		# f.write( "// E 1 Operator 3 Assign"+"\n")
		# f.close()
		...
		if IRObj.isValid()[1]:
			...
			# f = open(AssemFile,'a')
			# f.write( "// B 2 Operator 3 Assign"+"\n")
			# f.close()

			reg2= AssignRegister( _src2, IRObj.lineno, 1 )

			# f = open(AssemFile,'a')
			# f.write( "// E 2 Operator 3 Assign"+"\n")
			# f.close()
		...
		if IRObj.isValid()[0]:
			...
			# f = open(AssemFile,'a')
			# f.write( "// B 3 Operator 3 Assign"+"\n")
			# f.close()

			reg1= AssignRegister( _src1, IRObj.lineno, 1 )

			# f = open(AssemFile,'a')
			# f.write( "// E 3 Operator 3 Assign"+"\n")
			# f.close()
